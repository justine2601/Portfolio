...
class Matrix:
    ...
    def transpose_side(self):
        transposed = [[self.matrix[i][j] for i in range(-1, -len(self.matrix) - 1, -1)] for j in range(-1, -len(self.matrix[0]) - 1, -1)]
        print("\n")
        self.matrix = transposed
...
4. Transpose matrix\n5. Calculate a determinant\n0. Exit")
        choice = input()
        if choice == "1":
            print("Enter size of first matrix: "+"(eg. 2 2 , 3 3)")
            matrix_a = Matrix(input())
            print("Enter first matrix: ")
            matrix_a.create()

            print("Enter size of second matrix: "+"(eg. 2 2 , 3 3)")
            matrix_b = Matrix(input())
            print("Enter second matrix: "+"(eg. 2 2 , 3 3)")
            matrix_b.create()
            ...
            print("Enter size of matrix: "+"(eg. 2 2 , 3 3)")
            matrix_a = Matrix(input())
            print("Enter matrix: "+"(eg. 2 2 , 3 3)")
            matrix_a.create()
